...
<head>
    ...
    <meta basePath= "<?php $url->url(); ?>">
    <meta name = 'curentPage' value = ''>
    <link rel="shortcut icon" href="<?php echo $url->url(); ?>favicon.ico" type="image/x-icon">
    <title>QTT Panel [<?php echo $data->user; ?>]</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php $url->assets('css.mincss.siteStyle-min.css'); ?>" media="bogus">
</head>
